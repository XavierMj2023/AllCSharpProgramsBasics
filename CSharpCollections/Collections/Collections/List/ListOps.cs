...
namespace Collections.List
{
    public class ListOps
	{
		...
		public void ListOpsSwitch()
		{
			...
			{
				case 0:	break;
				case 1:	Console.WriteLine("The List elements are :");
						ListAddInt();
						break;
				case 2: Console.WriteLine("The List elements of string are : ");
						ListAddString(); 
						break;
				case 3: Console.WriteLine("Adding elements using collection initializer syntax");
						AddElementUsingCI();
						break;
				case 4: Console.WriteLine("Adding elements using object intializer syntax");
						AddElementUsingOI();
						break;
				case 5: Console.WriteLine("Adding Collection to the List");
						AddCOLL();
						break;
				case 6: Console.WriteLine("Accessing List through Index");
						AccessIndexEleList();
						break;
				case 7:
						...
						break;
				case 8: Console.WriteLine("Accessing List through foreach linq method (Object Intializer Syntax");
						AccessLINQEleListOI();
						break;
				case 9: Console.WriteLine("Insert element in List");
						InsertEle();
						break;
				case 10:Console.WriteLine("Remove Element in List");
						RemoveEle();
						break;
				case 11:Console.WriteLine("Checking Specified Element is there or not");
